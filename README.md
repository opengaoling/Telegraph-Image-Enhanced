...
This is an enhanced version of the original [Telegraph-Image](https://github.com/cf-pages/Telegraph-Image) project.

### Enhancements:
- **Standard HTTP Basic Auth**: Secure management backend with robust authentication.
- **Improved UX**: Added management links and better error handling for unauthorized access.
- **Telegram Integration**: Full support for Telegram as a storage and notification layer.

### Acknowledgements
Special thanks to the original author [cf-pages](https://github.com/cf-pages/Telegraph-Image) for the amazing foundation of this project. 感谢原作者的开源精神！
